...
python3 main.py gen  --model-path='tang_199.pth' --pickle-path='tang.npz' --start-words='江流天地外，' --prefix-words='郡邑浮前浦，波澜动远空。' --nouse-gpu --max_gen_len=60

江流天地外，天子晋天中。
python3 main.py gen  --model-path='tang_199.pth' --pickle-path='tang.npz' --start-words='宁知天地外，' --prefix-words='江流天地外，天子晋天中。' --nouse-gpu --max_gen_len=60
